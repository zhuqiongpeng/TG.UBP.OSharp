...
{
    public class EntityUserMapConfiguration_Oracle : EntityConfigurationBase<EntityUserMap, int>
    {
        public EntityUserMapConfiguration_Oracle()
        {
            //将实体映射到Oracle数据库
